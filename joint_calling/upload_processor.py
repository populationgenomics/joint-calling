...
def move_files(
    ...
    been validated at an earlier stage. The function will raise an error if invalid
    bucket details, or invalid sample names are produced."""
    ...
    for sample in sample_files:
        ...
        destination_blob = destination_bucket.get_blob(sample)
