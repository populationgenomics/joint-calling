...
@click.option(
    ...
    'and having the same name as the input MatrixTable, but with '
    'a suffix `.qc.ht`. The following columns are expected: '
    'sample,population,gvcf,contamination,alignment_summary_metrics,'
    'duplicate_metrics,insert_size_metrics,wgs_metrics. '
    'The first column is the only required one, and corresponds to '
