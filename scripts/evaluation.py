...
@click.option(
    ...
    help='Allele annotations (generated by generate_variant_qc_annotations.py)',
)
@click.option(
    '--fam-stats-ht',
    'fam_stats_ht_path',
    callback=get_validation_callback(ext='ht'),
    help='path to a Table with trio stats '
...
def create_bin_ht(
    ...
    :param qc_ac_ht: table generated by generate_variant_qc_annotations.py
